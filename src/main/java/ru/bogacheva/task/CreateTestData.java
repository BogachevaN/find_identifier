...
public class CreateTestData {
    ...
    private static void cretaeStructure() {
        ...
        createDir(new File("C://logs/logs1/dir1"));
        createDir(new File("C://logs/logs1/dir2"));
    ...
    private static void createLogs() throws IOException {
        ...
        createLog(new File("C://logs/logs1/dir1/dir1.log"), 600);
        createLog(new File("C://logs/logs1/dir2/dir2.log"), 700);
